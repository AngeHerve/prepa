...
<head>
  ...
  <title>PREPABEPCBAC - Chimie</title>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
                ...
                <div class="product">
                    <div class="row fadeInUp " data-wow-delay="0.5s">
                      ...
                      <div class="col-lg-4 col-sm-4 col-6" style="display: none;">
                        <a href="" class="d-block product-item rounded " style="margin-bottom: 15px;">
            ...
            <div class="load-wrap text-center">
              <button id="voirPlusBtn" class="btn btn-lg btn-primary">Voir plus</button>
            </div>
